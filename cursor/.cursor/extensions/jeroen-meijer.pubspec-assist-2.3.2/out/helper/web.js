...
exports.openNewGitIssueUrl = exports.generateNewGitIssueContent = exports.generateNewGitIssueUrl = void 0;
...
function openNewGitIssueUrl(error) {
    (0, openurl_1.open)(generateNewGitIssueUrl(generateNewGitIssueContent(error)));
}
