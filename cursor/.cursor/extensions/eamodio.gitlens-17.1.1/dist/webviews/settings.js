...
`;let ez=new WeakMap;function eI(t,e){return function(o,r,n){let a=ez.get(o.constructor);null==a&&ez.set(o.constructor,a=[]),a.push({method:n.value,keys:Array.isArray(t)?t:[t],afterFirstUpdate:e?.afterFirstUpdate??!1})}}let GlElement=class GlElement extends lit_element_i{emit(t,e,o){let r=new CustomEvent(t,{bubbles:!0,cancelable:!1,composed:!0,...o,detail:e});return this.dispatchEvent(r),r}update(t){let e=ez.get(this.constructor);if(null!=e)for(let{keys:o,method:r,afterFirstUpdate:n}of e){if(n&&!this.hasUpdated)continue;let e=o.filter(e=>t.has(e));e.length&&r.call(this,e)}super.update(t)}};var eF=tI`
  :host {
...
`,eQ=Object.defineProperty,eX=Object.defineProperties,e1=Object.getOwnPropertyDescriptor,e2=Object.getOwnPropertyDescriptors,e0=Object.getOwnPropertySymbols,e3=Object.prototype.hasOwnProperty,e5=Object.prototype.propertyIsEnumerable,e8=t=>{throw TypeError(t)},e9=(t,e,o)=>e in t?eQ(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o,e7=(t,e)=>{for(var o in e||(e={}))e3.call(e,o)&&e9(t,o,e[o]);if(e0)for(var o of e0(e))e5.call(e,o)&&e9(t,o,e[o]);return t},e4=(t,e)=>eX(t,e2(e)),e6=(t,e,o,r)=>{for(var n,a=r>1?void 0:r?e1(e,o):e,l=t.length-1;l>=0;l--)(n=t[l])&&(a=(r?n(e,o,a):n(a))||a);return r&&a&&eQ(e,o,a),a},it=(t,e,o)=>e.has(t)||e8("Cannot "+o),ie=(t,e,o)=>(it(t,e,"read from private field"),o?o.call(t):e.get(t)),ii=(t,e,o)=>e.has(t)?e8("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,o),io=(t,e,o,r)=>(it(t,e,"write to private field"),r?r.call(t,o):e.set(t,o),o),is=class extends lit_element_i{constructor(){super(),ii(this,g,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([t,e])=>{this.constructor.define(t,e)})}emit(t,e){let o=new CustomEvent(t,e7({bubbles:!0,cancelable:!1,composed:!0,detail:{}},e));return this.dispatchEvent(o),o}static define(t,e=this,o={}){let r=customElements.get(t);if(!r){try{customElements.define(t,e,o)}catch(r){customElements.define(t,class extends e{},o)}return}let n=" (unknown version)",a=n;if("version"in e&&e.version&&(n=" v"+e.version),"version"in r&&r.version&&(a=" v"+r.version),n&&a&&n===a)return}attributeChangedCallback(t,e,o){ie(this,g)||(this.constructor.elementProperties.forEach((t,e)=>{t.reflect&&null!=this[e]&&this.initialReflectedProperties.set(e,this[e])}),io(this,g,!0)),super.attributeChangedCallback(t,e,o)}willUpdate(t){super.willUpdate(t),this.initialReflectedProperties.forEach((e,o)=>{t.has(o)&&null==this[o]&&(this[o]=e)})}};g=new WeakMap,is.version="2.20.1",is.dependencies={},e6([eL()],is.prototype,"dir",2),e6([eL()],is.prototype,"lang",2);let ir=Math.min,ia=Math.max,il=Math.round,ih=Math.floor,ic=t=>({x:t,y:t}),id={left:"right",right:"left",bottom:"top",top:"bottom"},ip={start:"end",end:"start"};function iu(t,e){return"function"==typeof t?t(e):t}function ig(t){return t.split("-")[0]}function im(t){return t.split("-")[1]}function iv(t){return"x"===t?"y":"x"}function ib(t){return"y"===t?"height":"width"}function iy(t){return["top","bottom"].includes(ig(t))?"y":"x"}function iw(t){return t.replace(/start|end/g,t=>ip[t])}function i_(t){return t.replace(/left|right|bottom|top/g,t=>id[t])}function i$(t){return"number"!=typeof t?{top:0,right:0,bottom:0,left:0,...t}:{top:t,right:t,bottom:t,left:t}}function iC(t){let{x:e,y:o,width:r,height:n}=t;return{width:r,height:n,top:o,left:e,right:e+r,bottom:o+n,x:e,y:o}}function ix(t,e,o){let r,{reference:n,floating:a}=t,l=iy(e),h=iv(iy(e)),c=ib(h),d=ig(e),p="y"===l,u=n.x+n.width/2-a.width/2,g=n.y+n.height/2-a.height/2,f=n[c]/2-a[c]/2;switch(d){case"top":r={x:u,y:n.y-a.height};break;case"bottom":r={x:u,y:n.y+n.height};break;case"right":r={x:n.x+n.width,y:g};break;case"left":r={x:n.x-a.width,y:g};break;default:r={x:n.x,y:n.y}}switch(im(e)){case"start":r[h]-=f*(o&&p?-1:1);break;case"end":r[h]+=f*(o&&p?-1:1)}return r}let ik=async(t,e,o)=>{let{placement:r="bottom",strategy:n="absolute",middleware:a=[],platform:l}=o,h=a.filter(Boolean),c=await (null==l.isRTL?void 0:l.isRTL(e)),d=await l.getElementRects({reference:t,floating:e,strategy:n}),{x:p,y:u}=ix(d,r,c),g=r,f={},m=0;for(let o=0;o<h.length;o++){let{name:a,fn:v}=h[o],{x:b,y:w,data:_,reset:$}=await v({x:p,y:u,initialPlacement:r,placement:g,strategy:n,middlewareData:f,rects:d,platform:l,elements:{reference:t,floating:e}});p=null!=b?b:p,u=null!=w?w:u,f={...f,[a]:{...f[a],..._}},$&&m<=50&&(m++,"object"==typeof $&&($.placement&&(g=$.placement),$.rects&&(d=!0===$.rects?await l.getElementRects({reference:t,floating:e,strategy:n}):$.rects),{x:p,y:u}=ix(d,g,c)),o=-1)}return{x:p,y:u,placement:g,strategy:n,middlewareData:f}};async function iA(t,e){var o;void 0===e&&(e={});let{x:r,y:n,platform:a,rects:l,elements:h,strategy:c}=t,{boundary:d="clippingAncestors",rootBoundary:p="viewport",elementContext:u="floating",altBoundary:g=!1,padding:f=0}=iu(e,t),m=i$(f),v=h[g?"floating"===u?"reference":"floating":u],b=iC(await a.getClippingRect({element:null==(o=await (null==a.isElement?void 0:a.isElement(v)))||o?v:v.contextElement||await (null==a.getDocumentElement?void 0:a.getDocumentElement(h.floating)),boundary:d,rootBoundary:p,strategy:c})),w="floating"===u?{x:r,y:n,width:l.floating.width,height:l.floating.height}:l.reference,_=await (null==a.getOffsetParent?void 0:a.getOffsetParent(h.floating)),$=await (null==a.isElement?void 0:a.isElement(_))&&await (null==a.getScale?void 0:a.getScale(_))||{x:1,y:1},C=iC(a.convertOffsetParentRelativeRectToViewportRelativeRect?await a.convertOffsetParentRelativeRectToViewportRelativeRect({elements:h,rect:w,offsetParent:_,strategy:c}):w);return{top:(b.top-C.top+m.top)/$.y,bottom:(C.bottom-b.bottom+m.bottom)/$.y,left:(b.left-C.left+m.left)/$.x,right:(C.right-b.right+m.right)/$.x}}async function iS(t,e){let{placement:o,platform:r,elements:n}=t,a=await (null==r.isRTL?void 0:r.isRTL(n.floating)),l=ig(o),h=im(o),c="y"===iy(o),d=["left","top"].includes(l)?-1:1,p=a&&c?-1:1,u=iu(e,t),{mainAxis:g,crossAxis:f,alignmentAxis:m}="number"==typeof u?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:u.mainAxis||0,crossAxis:u.crossAxis||0,alignmentAxis:u.alignmentAxis};return h&&"number"==typeof m&&(f="end"===h?-1*m:m),c?{x:f*p,y:g*d}:{x:g*d,y:f*p}}function iP(){return"undefined"!=typeof window}function iL(t){return iT(t)?(t.nodeName||"").toLowerCase():"#document"}function iE(t){var e;return(null==t||null==(e=t.ownerDocument)?void 0:e.defaultView)||window}function iM(t){var e;return null==(e=(iT(t)?t.ownerDocument:t.document)||window.document)?void 0:e.documentElement}function iT(t){return!!iP()&&(t instanceof Node||t instanceof iE(t).Node)}function iR(t){return!!iP()&&(t instanceof Element||t instanceof iE(t).Element)}function iD(t){return!!iP()&&(t instanceof HTMLElement||t instanceof iE(t).HTMLElement)}function iO(t){return!!iP()&&"undefined"!=typeof ShadowRoot&&(t instanceof ShadowRoot||t instanceof iE(t).ShadowRoot)}function iB(t){let{overflow:e,overflowX:o,overflowY:r,display:n}=iF(t);return/auto|scroll|overlay|hidden|clip/.test(e+r+o)&&!["inline","contents"].includes(n)}function iH(t){return[":popover-open",":modal"].some(e=>{try{return t.matches(e)}catch{return!1}})}function iN(t){let e=iz(),o=iR(t)?iF(t):t;return["transform","translate","scale","rotate","perspective"].some(t=>!!o[t]&&"none"!==o[t])||!!o.containerType&&"normal"!==o.containerType||!e&&!!o.backdropFilter&&"none"!==o.backdropFilter||!e&&!!o.filter&&"none"!==o.filter||["transform","translate","scale","rotate","perspective","filter"].some(t=>(o.willChange||"").includes(t))||["paint","layout","strict","content"].some(t=>(o.contain||"").includes(t))}function iz(){return"undefined"!=typeof CSS&&!!CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")}function iI(t){return["html","body","#document"].includes(iL(t))}function iF(t){return iE(t).getComputedStyle(t)}function iU(t){return iR(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function ij(t){if("html"===iL(t))return t;let e=t.assignedSlot||t.parentNode||iO(t)&&t.host||iM(t);return iO(e)?e.host:e}function iq(t,e,o){var r;void 0===e&&(e=[]),void 0===o&&(o=!0);let n=function t(e){let o=ij(e);return iI(o)?e.ownerDocument?e.ownerDocument.body:e.body:iD(o)&&iB(o)?o:t(o)}(t),a=n===(null==(r=t.ownerDocument)?void 0:r.body),l=iE(n);if(a){let t=iV(l);return e.concat(l,l.visualViewport||[],iB(n)?n:[],t&&o?iq(t):[])}return e.concat(n,iq(n,[],o))}function iV(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function iZ(t){let e=iF(t),o=parseFloat(e.width)||0,r=parseFloat(e.height)||0,n=iD(t),a=n?t.offsetWidth:o,l=n?t.offsetHeight:r,h=il(o)!==a||il(r)!==l;return h&&(o=a,r=l),{width:o,height:r,$:h}}function iW(t){return iR(t)?t:t.contextElement}function iG(t){let e=iW(t);if(!iD(e))return ic(1);let o=e.getBoundingClientRect(),{width:r,height:n,$:a}=iZ(e),l=(a?il(o.width):o.width)/r,h=(a?il(o.height):o.height)/n;return l&&Number.isFinite(l)||(l=1),h&&Number.isFinite(h)||(h=1),{x:l,y:h}}let iY=ic(0);function iK(t){let e=iE(t);return iz()&&e.visualViewport?{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}:iY}function iJ(t,e,o,r){var n;void 0===e&&(e=!1),void 0===o&&(o=!1);let a=t.getBoundingClientRect(),l=iW(t),h=ic(1);e&&(r?iR(r)&&(h=iG(r)):h=iG(t));let c=(void 0===(n=o)&&(n=!1),r&&(!n||r===iE(l))&&n)?iK(l):ic(0),d=(a.left+c.x)/h.x,p=(a.top+c.y)/h.y,u=a.width/h.x,g=a.height/h.y;if(l){let t=iE(l),e=r&&iR(r)?iE(r):r,o=t,n=iV(o);for(;n&&r&&e!==o;){let t=iG(n),e=n.getBoundingClientRect(),r=iF(n),a=e.left+(n.clientLeft+parseFloat(r.paddingLeft))*t.x,l=e.top+(n.clientTop+parseFloat(r.paddingTop))*t.y;d*=t.x,p*=t.y,u*=t.x,g*=t.y,d+=a,p+=l,n=iV(o=iE(n))}}return iC({width:u,height:g,x:d,y:p})}function iQ(t,e){let o=iU(t).scrollLeft;return e?e.left+o:iJ(iM(t)).left+o}function iX(t,e,o){void 0===o&&(o=!1);let r=t.getBoundingClientRect();return{x:r.left+e.scrollLeft-(o?0:iQ(t,r)),y:r.top+e.scrollTop}}function i1(t,e,o){let r;if("viewport"===e)r=function(t,e){let o=iE(t),r=iM(t),n=o.visualViewport,a=r.clientWidth,l=r.clientHeight,h=0,c=0;if(n){a=n.width,l=n.height;let t=iz();(!t||t&&"fixed"===e)&&(h=n.offsetLeft,c=n.offsetTop)}return{width:a,height:l,x:h,y:c}}(t,o);else if("document"===e)r=function(t){let e=iM(t),o=iU(t),r=t.ownerDocument.body,n=ia(e.scrollWidth,e.clientWidth,r.scrollWidth,r.clientWidth),a=ia(e.scrollHeight,e.clientHeight,r.scrollHeight,r.clientHeight),l=-o.scrollLeft+iQ(t),h=-o.scrollTop;return"rtl"===iF(r).direction&&(l+=ia(e.clientWidth,r.clientWidth)-n),{width:n,height:a,x:l,y:h}}(iM(t));else if(iR(e))r=function(t,e){let o=iJ(t,!0,"fixed"===e),r=o.top+t.clientTop,n=o.left+t.clientLeft,a=iD(t)?iG(t):ic(1),l=t.clientWidth*a.x,h=t.clientHeight*a.y;return{width:l,height:h,x:n*a.x,y:r*a.y}}(e,o);else{let o=iK(t);r={x:e.x-o.x,y:e.y-o.y,width:e.width,height:e.height}}return iC(r)}function i2(t){return"static"===iF(t).position}function i0(t,e){if(!iD(t)||"fixed"===iF(t).position)return null;if(e)return e(t);let o=t.offsetParent;return iM(t)===o&&(o=o.ownerDocument.body),o}function i3(t,e){let o=iE(t);if(iH(t))return o;if(!iD(t)){let e=ij(t);for(;e&&!iI(e);){if(iR(e)&&!i2(e))return e;e=ij(e)}return o}let r=i0(t,e);for(;r&&["table","td","th"].includes(iL(r))&&i2(r);)r=i0(r,e);return r&&iI(r)&&i2(r)&&!iN(r)?o:r||function(t){let e=ij(t);for(;iD(e)&&!iI(e);){if(iN(e))return e;if(iH(e))break;e=ij(e)}return null}(t)||o}let i5=async function(t){let e=this.getOffsetParent||i3,o=this.getDimensions,r=await o(t.floating);return{reference:function(t,e,o){let r=iD(e),n=iM(e),a="fixed"===o,l=iJ(t,!0,a,e),h={scrollLeft:0,scrollTop:0},c=ic(0);if(r||!r&&!a)if(("body"!==iL(e)||iB(n))&&(h=iU(e)),r){let t=iJ(e,!0,a,e);c.x=t.x+e.clientLeft,c.y=t.y+e.clientTop}else n&&(c.x=iQ(n));a&&!r&&n&&(c.x=iQ(n));let d=!n||r||a?ic(0):iX(n,h);return{x:l.left+h.scrollLeft-c.x-d.x,y:l.top+h.scrollTop-c.y-d.y,width:l.width,height:l.height}}(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}},i8={convertOffsetParentRelativeRectToViewportRelativeRect:function(t){let{elements:e,rect:o,offsetParent:r,strategy:n}=t,a="fixed"===n,l=iM(r),h=!!e&&iH(e.floating);if(r===l||h&&a)return o;let c={scrollLeft:0,scrollTop:0},d=ic(1),p=ic(0),u=iD(r);if((u||!u&&!a)&&(("body"!==iL(r)||iB(l))&&(c=iU(r)),iD(r))){let t=iJ(r);d=iG(r),p.x=t.x+r.clientLeft,p.y=t.y+r.clientTop}let g=!l||u||a?ic(0):iX(l,c,!0);return{width:o.width*d.x,height:o.height*d.y,x:o.x*d.x-c.scrollLeft*d.x+p.x+g.x,y:o.y*d.y-c.scrollTop*d.y+p.y+g.y}},getDocumentElement:iM,getClippingRect:function(t){let{element:e,boundary:o,rootBoundary:r,strategy:n}=t,a=[..."clippingAncestors"===o?iH(e)?[]:function(t,e){let o=e.get(t);if(o)return o;let r=iq(t,[],!1).filter(t=>iR(t)&&"body"!==iL(t)),n=null,a="fixed"===iF(t).position,l=a?ij(t):t;for(;iR(l)&&!iI(l);){let e=iF(l),o=iN(l);o||"fixed"!==e.position||(n=null),(a?!o&&!n:!o&&"static"===e.position&&!!n&&["absolute","fixed"].includes(n.position)||iB(l)&&!o&&function t(e,o){let r=ij(e);return!(r===o||!iR(r)||iI(r))&&("fixed"===iF(r).position||t(r,o))}(t,l))?r=r.filter(t=>t!==l):n=e,l=ij(l)}return e.set(t,r),r}(e,this._c):[].concat(o),r],l=a[0],h=a.reduce((t,o)=>{let r=i1(e,o,n);return t.top=ia(r.top,t.top),t.right=ir(r.right,t.right),t.bottom=ir(r.bottom,t.bottom),t.left=ia(r.left,t.left),t},i1(e,l,n));return{width:h.right-h.left,height:h.bottom-h.top,x:h.left,y:h.top}},getOffsetParent:i3,getElementRects:i5,getClientRects:function(t){return Array.from(t.getClientRects())},getDimensions:function(t){let{width:e,height:o}=iZ(t);return{width:e,height:o}},getScale:iG,isElement:iR,isRTL:function(t){return"rtl"===iF(t).direction}};function i9(t,e){return t.x===e.x&&t.y===e.y&&t.width===e.width&&t.height===e.height}let i7=function(t){return void 0===t&&(t={}),{name:"size",options:t,async fn(e){var o,r;let n,a,{placement:l,rects:h,platform:c,elements:d}=e,{apply:p=()=>{},...u}=iu(t,e),g=await iA(e,u),f=ig(l),m=im(l),v="y"===iy(l),{width:b,height:w}=h.floating;"top"===f||"bottom"===f?(n=f,a=m===(await (null==c.isRTL?void 0:c.isRTL(d.floating))?"start":"end")?"left":"right"):(a=f,n="end"===m?"top":"bottom");let _=w-g.top-g.bottom,$=b-g.left-g.right,C=ir(w-g[n],_),x=ir(b-g[a],$),A=!e.middlewareData.shift,S=C,P=x;if(null!=(o=e.middlewareData.shift)&&o.enabled.x&&(P=$),null!=(r=e.middlewareData.shift)&&r.enabled.y&&(S=_),A&&!m){let t=ia(g.left,0),e=ia(g.right,0),o=ia(g.top,0),r=ia(g.bottom,0);v?P=b-2*(0!==t||0!==e?t+e:ia(g.left,g.right)):S=w-2*(0!==o||0!==r?o+r:ia(g.top,g.bottom))}await p({...e,availableWidth:P,availableHeight:S});let E=await c.getDimensions(d.floating);return b!==E.width||w!==E.height?{reset:{rects:!0}}:{}}}},i4=t=>({name:"arrow",options:t,async fn(e){let{x:o,y:r,placement:n,rects:a,platform:l,elements:h,middlewareData:c}=e,{element:d,padding:p=0}=iu(t,e)||{};if(null==d)return{};let u=i$(p),g={x:o,y:r},f=iv(iy(n)),m=ib(f),v=await l.getDimensions(d),b="y"===f,w=b?"clientHeight":"clientWidth",_=a.reference[m]+a.reference[f]-g[f]-a.floating[m],$=g[f]-a.reference[f],C=await (null==l.getOffsetParent?void 0:l.getOffsetParent(d)),x=C?C[w]:0;x&&await (null==l.isElement?void 0:l.isElement(C))||(x=h.floating[w]||a.floating[m]);let A=x/2-v[m]/2-1,S=ir(u[b?"top":"left"],A),P=ir(u[b?"bottom":"right"],A),E=x-v[m]-P,T=x/2-v[m]/2+(_/2-$/2),D=ia(S,ir(T,E)),O=!c.arrow&&null!=im(n)&&T!==D&&a.reference[m]/2-(T<S?S:P)-v[m]/2<0,B=O?T<S?T-S:T-E:0;return{[f]:g[f]+B,data:{[f]:D,centerOffset:T-D-B,...O&&{alignmentOffset:B}},reset:O}}}),i6=(t,e,o)=>{let r=new Map,n={platform:i8,...o},a={...n.platform,_c:r};return ik(t,e,{...n,platform:a})},ot=t=>(...e)=>({_$litDirective$:t,values:e});let directive_i=class directive_i{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,o){this._$Ct=t,this._$AM=e,this._$Ci=o}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};let oe=ot(class extends directive_i{constructor(t){if(super(t),1!==t.type||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){for(let o in this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),e)e[o]&&!this.nt?.has(o)&&this.st.add(o);return this.render(e)}let o=t.element.classList;for(let t of this.st)t in e||(o.remove(t),this.st.delete(t));for(let t in e){let r=!!e[t];r===this.st.has(t)||this.nt?.has(t)||(r?(o.add(t),this.st.add(t)):(o.remove(t),this.st.delete(t)))}return ef}});function oi(t){var e=t;for(let t=e;t;t=oo(t))if(t instanceof Element&&"none"===getComputedStyle(t).display)return null;for(let t=oo(e);t;t=oo(t)){if(!(t instanceof Element))continue;let e=getComputedStyle(t);if("contents"!==e.display&&("static"!==e.position||iN(e)||"BODY"===t.tagName))return t}return null}function oo(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}var os=class extends is{constructor(){super(...arguments),this.localize=new eK(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let t=this.anchorEl.getBoundingClientRect(),e=this.popup.getBoundingClientRect(),o=this.placement.includes("top")||this.placement.includes("bottom"),r=0,n=0,a=0,l=0,h=0,c=0,d=0,p=0;o?t.top<e.top?(r=t.left,n=t.bottom,a=t.right,l=t.bottom,h=e.left,c=e.top,d=e.right,p=e.top):(r=e.left,n=e.bottom,a=e.right,l=e.bottom,h=t.left,c=t.top,d=t.right,p=t.top):t.left<e.left?(r=t.right,n=t.top,a=e.left,l=e.top,h=t.right,c=t.bottom,d=e.left,p=e.bottom):(r=e.right,n=e.top,a=t.left,l=t.top,h=e.right,c=e.bottom,d=t.left,p=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${r}px`),this.style.setProperty("--hover-bridge-top-left-y",`${n}px`),this.style.setProperty("--hover-bridge-top-right-x",`${a}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${h}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${p}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){let t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else{var t;this.anchor instanceof Element||null!==(t=this.anchor)&&"object"==typeof t&&"getBoundingClientRect"in t&&(!("contextElement"in t)||t.contextElement instanceof Element)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]')}this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&this.active&&(this.cleanup=function(t,e,o,r){let n;void 0===r&&(r={});let{ancestorScroll:a=!0,ancestorResize:l=!0,elementResize:h="function"==typeof ResizeObserver,layoutShift:c="function"==typeof IntersectionObserver,animationFrame:d=!1}=r,p=iW(t),u=a||l?[...p?iq(p):[],...iq(e)]:[];u.forEach(t=>{a&&t.addEventListener("scroll",o,{passive:!0}),l&&t.addEventListener("resize",o)});let g=p&&c?function(t,e){let o,r=null,n=iM(t);function a(){var t;clearTimeout(o),null==(t=r)||t.disconnect(),r=null}return!function l(h,c){void 0===h&&(h=!1),void 0===c&&(c=1),a();let d=t.getBoundingClientRect(),{left:p,top:u,width:g,height:f}=d;if(h||e(),!g||!f)return;let m=ih(u),v=ih(n.clientWidth-(p+g)),b={rootMargin:-m+"px "+-v+"px "+-ih(n.clientHeight-(u+f))+"px "+-ih(p)+"px",threshold:ia(0,ir(1,c))||1},w=!0;function _(e){let r=e[0].intersectionRatio;if(r!==c){if(!w)return l();r?l(!1,r):o=setTimeout(()=>{l(!1,1e-7)},1e3)}1!==r||i9(d,t.getBoundingClientRect())||l(),w=!1}try{r=new IntersectionObserver(_,{...b,root:n.ownerDocument})}catch{r=new IntersectionObserver(_,b)}r.observe(t)}(!0),a}(p,o):null,f=-1,m=null;h&&(m=new ResizeObserver(t=>{let[r]=t;r&&r.target===p&&m&&(m.unobserve(e),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var t;null==(t=m)||t.observe(e)})),o()}),p&&!d&&m.observe(p),m.observe(e));let v=d?iJ(t):null;return d&&function e(){let r=iJ(t);v&&!i9(v,r)&&o(),v=r,n=requestAnimationFrame(e)}(),o(),()=>{var t;u.forEach(t=>{a&&t.removeEventListener("scroll",o),l&&t.removeEventListener("resize",o)}),null==g||g(),null==(t=m)||t.disconnect(),m=null,d&&cancelAnimationFrame(n)}}(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t()})}reposition(){var t,e,o;if(!this.active||!this.anchorEl)return;let r=[{name:"offset",options:t={mainAxis:this.distance,crossAxis:this.skidding},async fn(e){var o,r;let{x:n,y:a,placement:l,middlewareData:h}=e,c=await iS(e,t);return l===(null==(o=h.offset)?void 0:o.placement)&&null!=(r=h.arrow)&&r.alignmentOffset?{}:{x:n+c.x,y:a+c.y,data:{...c,placement:l}}}}];this.sync?r.push(i7({apply:({rects:t})=>{let e="width"===this.sync||"both"===this.sync,o="height"===this.sync||"both"===this.sync;this.popup.style.width=e?`${t.reference.width}px`:"",this.popup.style.height=o?`${t.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&r.push({name:"flip",options:e={boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding},async fn(t){var o,r,n,a,l,h;let{placement:c,middlewareData:d,rects:p,initialPlacement:u,platform:g,elements:f}=t,{mainAxis:m=!0,crossAxis:v=!0,fallbackPlacements:b,fallbackStrategy:w="bestFit",fallbackAxisSideDirection:_="none",flipAlignment:$=!0,...C}=iu(e,t);if(null!=(o=d.arrow)&&o.alignmentOffset)return{};let x=ig(c),A=iy(u),S=ig(u)===u,P=await (null==g.isRTL?void 0:g.isRTL(f.floating)),E=b||(S||!$?[i_(u)]:function(t){let e=i_(t);return[iw(t),e,iw(e)]}(u)),T="none"!==_;!b&&T&&E.push(...function(t,e,o,r){let n=im(t),a=function(t,e,o){let r=["left","right"],n=["right","left"];switch(t){case"top":case"bottom":if(o)return e?n:r;return e?r:n;case"left":case"right":return e?["top","bottom"]:["bottom","top"];default:return[]}}(ig(t),"start"===o,r);return n&&(a=a.map(t=>t+"-"+n),e&&(a=a.concat(a.map(iw)))),a}(u,$,_,P));let D=[u,...E],O=await iA(t,C),B=[],F=(null==(r=d.flip)?void 0:r.overflows)||[];if(m&&B.push(O[x]),v){let t=function(t,e,o){void 0===o&&(o=!1);let r=im(t),n=iv(iy(t)),a=ib(n),l="x"===n?r===(o?"end":"start")?"right":"left":"start"===r?"bottom":"top";return e.reference[a]>e.floating[a]&&(l=i_(l)),[l,i_(l)]}(c,p,P);B.push(O[t[0]],O[t[1]])}if(F=[...F,{placement:c,overflows:B}],!B.every(t=>t<=0)){let t=((null==(n=d.flip)?void 0:n.index)||0)+1,e=D[t];if(e){let o="alignment"===v&&A!==iy(e),r=(null==(l=F[0])?void 0:l.overflows[0])>0;if(!o||r)return{data:{index:t,overflows:F},reset:{placement:e}}}let o=null==(a=F.filter(t=>t.overflows[0]<=0).sort((t,e)=>t.overflows[1]-e.overflows[1])[0])?void 0:a.placement;if(!o)switch(w){case"bestFit":{let t=null==(h=F.filter(t=>{if(T){let e=iy(t.placement);return e===A||"y"===e}return!0}).map(t=>[t.placement,t.overflows.filter(t=>t>0).reduce((t,e)=>t+e,0)]).sort((t,e)=>t[1]-e[1])[0])?void 0:h[0];t&&(o=t);break}case"initialPlacement":o=u}if(c!==o)return{reset:{placement:o}}}return{}}}),this.shift&&r.push({name:"shift",options:o={boundary:this.shiftBoundary,padding:this.shiftPadding},async fn(t){let{x:e,y:r,placement:n}=t,{mainAxis:a=!0,crossAxis:l=!1,limiter:h={fn:t=>{let{x:e,y:o}=t;return{x:e,y:o}}},...c}=iu(o,t),d={x:e,y:r},p=await iA(t,c),u=iy(ig(n)),g=iv(u),f=d[g],m=d[u];if(a){let t="y"===g?"top":"left",e="y"===g?"bottom":"right",o=f+p[t],r=f-p[e];f=ia(o,ir(f,r))}if(l){let t="y"===u?"top":"left",e="y"===u?"bottom":"right",o=m+p[t],r=m-p[e];m=ia(o,ir(m,r))}let v=h.fn({...t,[g]:f,[u]:m});return{...v,data:{x:v.x-e,y:v.y-r,enabled:{[g]:a,[u]:l}}}}}),this.autoSize?r.push(i7({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:t,availableHeight:e})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${e}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${t}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&r.push(i4({element:this.arrowEl,padding:this.arrowPadding}));let n="absolute"===this.strategy?t=>i8.getOffsetParent(t,oi):i8.getOffsetParent;i6(this.anchorEl,this.popup,{placement:this.placement,middleware:r,strategy:this.strategy,platform:e4(e7({},i8),{getOffsetParent:n})}).then(({x:t,y:e,middlewareData:o,placement:r})=>{let n="rtl"===this.localize.dir(),a={top:"bottom",right:"left",bottom:"top",left:"right"}[r.split("-")[0]];if(this.setAttribute("data-current-placement",r),Object.assign(this.popup.style,{left:`${t}px`,top:`${e}px`}),this.arrow){let t=o.arrow.x,e=o.arrow.y,r="",l="",h="",c="";if("start"===this.arrowPlacement){let o="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";r="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",l=n?o:"",c=n?"":o}else if("end"===this.arrowPlacement){let o="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";l=n?"":o,c=n?o:"",h="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(c="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":"",r="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":""):(c="number"==typeof t?`${t}px`:"",r="number"==typeof e?`${e}px`:"");Object.assign(this.arrowEl.style,{top:r,right:l,bottom:h,left:c,[a]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return eg`
      ...
      <div
        part="popup"
        class=${oe({popup:!0,"popup--active":this.active,"popup--fixed":"fixed"===this.strategy,"popup--has-arrow":this.arrow})}
      >
        <slot></slot>
        ${this.arrow?eg`<div part="arrow" class="popup__arrow" role="presentation"></div>`:""}
      </div>
    `}};os.styles=[eJ,eF],e6([eM(".popup")],os.prototype,"popup",2),e6([eM(".popup__arrow")],os.prototype,"arrowEl",2),e6([eL()],os.prototype,"anchor",2),e6([eL({type:Boolean,reflect:!0})],os.prototype,"active",2),e6([eL({reflect:!0})],os.prototype,"placement",2),e6([eL({reflect:!0})],os.prototype,"strategy",2),e6([eL({type:Number})],os.prototype,"distance",2),e6([eL({type:Number})],os.prototype,"skidding",2),e6([eL({type:Boolean})],os.prototype,"arrow",2),e6([eL({attribute:"arrow-placement"})],os.prototype,"arrowPlacement",2),e6([eL({attribute:"arrow-padding",type:Number})],os.prototype,"arrowPadding",2),e6([eL({type:Boolean})],os.prototype,"flip",2),e6([eL({attribute:"flip-fallback-placements",converter:{fromAttribute:t=>t.split(" ").map(t=>t.trim()).filter(t=>""!==t),toAttribute:t=>t.join(" ")}})],os.prototype,"flipFallbackPlacements",2),e6([eL({attribute:"flip-fallback-strategy"})],os.prototype,"flipFallbackStrategy",2),e6([eL({type:Object})],os.prototype,"flipBoundary",2),e6([eL({attribute:"flip-padding",type:Number})],os.prototype,"flipPadding",2),e6([eL({type:Boolean})],os.prototype,"shift",2),e6([eL({type:Object})],os.prototype,"shiftBoundary",2),e6([eL({attribute:"shift-padding",type:Number})],os.prototype,"shiftPadding",2),e6([eL({attribute:"auto-size"})],os.prototype,"autoSize",2),e6([eL()],os.prototype,"sync",2),e6([eL({type:Object})],os.prototype,"autoSizeBoundary",2),e6([eL({attribute:"auto-size-padding",type:Number})],os.prototype,"autoSizePadding",2),e6([eL({attribute:"hover-bridge",type:Boolean})],os.prototype,"hoverBridge",2),os.define("sl-popup");var or=Object.defineProperty,on=Object.getOwnPropertyDescriptor,oa=(t,e,o,r)=>{for(var n,a=r>1?void 0:r?on(e,o):e,l=t.length-1;l>=0;l--)(n=t[l])&&(a=(r?n(e,o,a):n(a))||a);return r&&a&&or(e,o,a),a};let ol=class extends GlElement{constructor(){super(),this.placement="bottom",this.disabled=!1,this.distance=8,this.open=!1,this.arrow=!0,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleTriggerBlur=t=>{this.open&&this.hasTrigger("focus")&&(t.relatedTarget&&this.contains(t.relatedTarget)||this.hide())},this.handleTriggerClick=t=>{if(this.hasTrigger("click"))if(this.open&&"hover"!==this._triggeredBy){if(this._skipHideOnClick){this._skipHideOnClick=!1;return}if(t.composedPath().includes(this.body))return;this.hide()}else this.show("click")},this._skipHideOnClick=!1,this.handleTriggerMouseDown=()=>{this.hasTrigger("click")&&this.hasTrigger("focus")&&!this.matches(":focus-within")?this._skipHideOnClick=!0:this._skipHideOnClick=!1},this.handleTriggerFocus=()=>{this.hasTrigger("focus")&&(this.open&&"hover"!==this._triggeredBy&&!this.hasPopupFocus()?this.hide():this.show("focus"))},this.handleDocumentKeyDown=t=>{"Escape"===t.key&&(t.stopPropagation(),this.hide())},this.handlePopupBlur=t=>{let e=t.composedPath();e.includes(this)||e.includes(this.body)||this.hide()},this.handleWebviewBlur=()=>{this.hide()},this.handleWebviewMouseDown=t=>{let e=t.composedPath();e.includes(this)||e.includes(this.body)||this.hide()},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);let t=tf(getComputedStyle(this).getPropertyValue("--show-delay"));this.hoverTimeout=setTimeout(()=>this.show("hover"),t)}},this.handleMouseOut=t=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);let e=t.composedPath();if(e[e.length-2]===this||this.hasPopupFocus()||"hover"!==this._triggeredBy)return;let o=tf(getComputedStyle(this).getPropertyValue("--hide-delay"));this.hoverTimeout=setTimeout(()=>this.hide(),o)}},this.addEventListener("blur",this.handleTriggerBlur,!0),this.addEventListener("focus",this.handleTriggerFocus,!0),this.addEventListener("click",this.handleTriggerClick),this.addEventListener("mousedown",this.handleTriggerMouseDown),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}static closeOthers(t){for(let e of ol.openPopovers)e===t||e.compareDocumentPosition(t)&Node.DOCUMENT_POSITION_CONTAINS||e.hide()}get currentPlacement(){return this.popup?.getAttribute("data-current-placement")??this.placement}disconnectedCallback(){this.closeWatcher?.destroy(),document.removeEventListener("focusin",this.handlePopupBlur),window.removeEventListener("webview-blur",this.handleWebviewBlur,!1),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleWebviewMouseDown),ol.openPopovers.delete(this),super.disconnectedCallback()}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}render(){return eg`<sl-popup
			part="base"
			exportparts="
				popup:base__popup,
				arrow:base__arrow
		...
		`],oa([eM("#popover")],ol.prototype,"body",2),oa([eM("sl-popup")],ol.prototype,"popup",2),oa([eL({reflect:!0})],ol.prototype,"placement",2),oa([eL({type:Object})],ol.prototype,"anchor",2),oa([eL({reflect:!0,type:Boolean})],ol.prototype,"disabled",2),oa([eL({type:Number})],ol.prototype,"distance",2),oa([eL({reflect:!0,type:Boolean})],ol.prototype,"open",2),oa([eL({reflect:!0,type:Boolean})],ol.prototype,"arrow",2),oa([eL({type:Number})],ol.prototype,"skidding",2),oa([eL()],ol.prototype,"trigger",2),oa([eL({type:Boolean})],ol.prototype,"hoist",2),oa([eL({reflect:!0})],ol.prototype,"appearance",2),oa([eI("open",{afterFirstUpdate:!0})],ol.prototype,"handleOpenChange",1),oa([eI(["distance","hoist","placement","skidding"])],ol.prototype,"handleOptionsChange",1),oa([eI("disabled")],ol.prototype,"handleDisabledChange",1),ol=oa([eA("gl-popover")],ol);var oh=new Map,oc=new WeakMap;function od(t,e){return"rtl"===e.toLowerCase()?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function op(t,e){oh.set(t,null!=e?e:{keyframes:[],options:{duration:0}})}function ou(t,e,o){let r=oc.get(t);if(null==r?void 0:r[e])return od(r[e],o.dir);let n=oh.get(e);return n?od(n,o.dir):{keyframes:[],options:{duration:0}}}let unsafe_html_e=class unsafe_html_e extends directive_i{constructor(t){if(super(t),this.it=em,2!==t.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===em||null==t)return this._t=void 0,this.it=t;if(t===ef)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};unsafe_html_e.directiveName="unsafeHTML",unsafe_html_e.resultType=1;let og=ot(unsafe_html_e);var of=tI`
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
    --show-delay: 150ms;
...
`;function om(t,e){return new Promise(o=>{t.addEventListener(e,function r(n){n.target===t&&(t.removeEventListener(e,r),o())})})}function ov(t,e,o){return new Promise(r=>{if((null==o?void 0:o.duration)===1/0)throw Error("Promise-based animations must be finite.");let n=t.animate(e,e4(e7({},o),{duration:window.matchMedia("(prefers-reduced-motion: reduce)").matches?0:o.duration}));n.addEventListener("cancel",r,{once:!0}),n.addEventListener("finish",r,{once:!0})})}function ob(t){return(t=t.toString().toLowerCase()).indexOf("ms")>-1?parseFloat(t):t.indexOf("s")>-1?1e3*parseFloat(t):parseFloat(t)}function oy(t){return Promise.all(t.getAnimations().map(t=>new Promise(e=>{t.cancel(),requestAnimationFrame(e)})))}function ow(t,e){let o=e7({waitUntilFirstUpdate:!1},e);return(e,r)=>{let{update:n}=e,a=Array.isArray(t)?t:[t];e.update=function(t){a.forEach(e=>{if(t.has(e)){let n=t.get(e),a=this[e];n!==a&&(!o.waitUntilFirstUpdate||this.hasUpdated)&&this[r](n,a)}}),n.call(this,t)}}}var o_=class extends is{constructor(){super(),this.localize=new eK(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=t=>{"Escape"===t.key&&(t.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){let t=ob(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),t)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){let t=ob(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),t)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var t;super.disconnectedCallback(),null==(t=this.closeWatcher)||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(t){return this.trigger.split(" ").includes(t)}async handleOpenChange(){var t,e;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?(null==(t=this.closeWatcher)||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await oy(this.body),this.body.hidden=!1,this.popup.active=!0;let{keyframes:e,options:o}=ou(this,"tooltip.show",{dir:this.localize.dir()});await ov(this.popup.popup,e,o),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),null==(e=this.closeWatcher)||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await oy(this.body);let{keyframes:t,options:o}=ou(this,"tooltip.hide",{dir:this.localize.dir()});await ov(this.popup.popup,t,o),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,om(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,om(this,"sl-after-hide")}render(){return eg`
      <sl-popup
        part="base"
        exportparts="
          popup:base__popup,
    ...
    `}};o_.styles=[eJ,of],o_.dependencies={"sl-popup":os},e6([eM("slot:not([name])")],o_.prototype,"defaultSlot",2),e6([eM(".tooltip__body")],o_.prototype,"body",2),e6([eM("sl-popup")],o_.prototype,"popup",2),e6([eL()],o_.prototype,"content",2),e6([eL()],o_.prototype,"placement",2),e6([eL({type:Boolean,reflect:!0})],o_.prototype,"disabled",2),e6([eL({type:Number})],o_.prototype,"distance",2),e6([eL({type:Boolean,reflect:!0})],o_.prototype,"open",2),e6([eL({type:Number})],o_.prototype,"skidding",2),e6([eL()],o_.prototype,"trigger",2),e6([eL({type:Boolean})],o_.prototype,"hoist",2),e6([ow("open",{waitUntilFirstUpdate:!0})],o_.prototype,"handleOpenChange",1),e6([ow(["content","distance","hoist","placement","skidding"])],o_.prototype,"handleOptionsChange",1),e6([ow("disabled")],o_.prototype,"handleDisabledChange",1),op("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}}),op("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}}),o_.define("sl-tooltip");var o$=Object.defineProperty,oC=Object.getOwnPropertyDescriptor,ox=(t,e,o,r)=>{for(var n,a=r>1?void 0:r?oC(e,o):e,l=t.length-1;l>=0;l--)(n=t[l])&&(a=(r?n(e,o,a):n(a))||a);return r&&a&&o$(e,o,a),a};op("tooltip.show",null),op("tooltip.hide",null);let ok=class extends lit_element_i{constructor(){super(...arguments),this.placement="bottom",this.disabled=!1}firstUpdated(){this.observer=new MutationObserver(t=>{for(let e of t)if("attributes"===e.type&&"data-current-placement"===e.attributeName){let t=e.target.getAttribute("data-current-placement");t?this.setAttribute("data-current-placement",t):this.removeAttribute("data-current-placement")}});let t=this.shadowRoot?.querySelector("sl-tooltip")?.shadowRoot;t&&this.observer.observe(t,{attributes:!0,attributeFilter:["data-current-placement"],subtree:!0})}disconnectedCallback(){this.observer?.disconnect(),super.disconnectedCallback()}render(){var t;return eg`<sl-tooltip
			.placement=${this.placement}
...
`)?og(t.replace(/\n\n/g,"<hr>").replace(/\n/g,"<br>")):t}</slot>
	...
	`,ox([eL()],ok.prototype,"content",2),ox([eL({reflect:!0})],ok.prototype,"placement",2),ox([eL({type:Boolean})],ok.prototype,"disabled",2),ox([eL({type:Number})],ok.prototype,"distance",2),ox([eL({type:Boolean})],ok.prototype,"hoist",2),ok=ox([eA("gl-tooltip")],ok);let oA=t=>t??em,{I:oS}={M:t9,P:t7,A:t4,C:1,L:ew,R:M,D:es,V:e_,I:R,H:k,N:I,U:L,B:H,F:z},oP=t=>null===t||"object"!=typeof t&&"function"!=typeof t,oL=t=>void 0===t.strings,oE=(t,e)=>{let o=t._$AN;if(void 0===o)return!1;for(let t of o)t._$AO?.(e,!1),oE(t,e);return!0},oM=t=>{let e,o;do{if(void 0===(e=t._$AM))break;(o=e._$AN).delete(t),t=e}while(0===o?.size)},oT=t=>{for(let e;e=t._$AM;t=e){let o=e._$AN;if(void 0===o)e._$AN=o=new Set;else if(o.has(t))break;o.add(t),oO(e)}};function oR(t){void 0!==this._$AN?(oM(this),this._$AM=t,oT(this)):this._$AM=t}function oD(t,e=!1,o=0){let r=this._$AH,n=this._$AN;if(void 0!==n&&0!==n.size)if(e)if(Array.isArray(r))for(let t=o;t<r.length;t++)oE(r[t],!1),oM(r[t]);else null!=r&&(oE(r,!1),oM(r));else oE(this,t)}let oO=t=>{2==t.type&&(t._$AP??=oD,t._$AQ??=oR)};let async_directive_f=class async_directive_f extends directive_i{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,o){super._$AT(t,e,o),oT(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(oE(this,t),oM(this))}setValue(t){if(oL(this._$Ct))this._$Ct._$AI(t,this);else{let e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}};let private_async_helpers_s=class private_async_helpers_s{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}};let private_async_helpers_i=class private_async_helpers_i{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise(t=>this.Z=t)}resume(){this.Z?.(),this.Y=this.Z=void 0}};let oB=t=>!oP(t)&&"function"==typeof t.then;let until_c=class until_c extends async_directive_f{constructor(){super(...arguments),this._$Cwt=0x3fffffff,this._$Cbt=[],this._$CK=new private_async_helpers_s(this),this._$CX=new private_async_helpers_i}render(...t){return t.find(t=>!oB(t))??ef}update(t,e){let o=this._$Cbt,r=o.length;this._$Cbt=e;let n=this._$CK,a=this._$CX;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cwt);t++){let l=e[t];if(!oB(l))return this._$Cwt=t,l;t<r&&l===o[t]||(this._$Cwt=0x3fffffff,r=0,Promise.resolve(l).then(async t=>{for(;a.get();)await a.get();let e=n.deref();if(void 0!==e){let o=e._$Cbt.indexOf(l);o>-1&&o<e._$Cwt&&(e._$Cwt=o,e.setValue(t))}}))}return ef}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};let oH=ot(until_c);var oN=Object.defineProperty,oz=Object.getOwnPropertyDescriptor,oI=(t,e,o,r)=>{for(var n,a=r>1?void 0:r?oz(e,o):e,l=t.length-1;l>=0;l--)(n=t[l])&&(a=(r?n(e,o,a):n(a))||a);return r&&a&&oN(e,o,a),a};let oF=class extends lit_element_i{constructor(){super(...arguments),this.type="info",this._hasPromo=!1}get hasPromo(){return this._hasPromo}set hasPromo(t){this._hasPromo=t}render(){return eg`${oH(this.promoPromise?.then(t=>this.renderPromo(t)),em)}`}renderPromo(t){if(!t?.content?.webview){this.hasPromo=!1;return}let e=t.content.webview;switch(this.type){case"info":if(e.info)return this.hasPromo=!0,eg`<p class="promo" part="text">${og(e.info.html)}</p>`;break;case"link":if(e.link)return this.hasPromo=!0,eg`<a
						class="link"
						part="link"
						href="${this.getCommandUrl(t)}"
						title="${oA(e.link.title)}"
						>${og(e.link.html)}</a
					>`}return this.hasPromo=!1,em}getCommandUrl(t){let e;return t?.content?.webview?.link?.command?.startsWith("command:")&&(e=t.content.webview.link.command.substring(8)),b(e??"gitlens.plus.upgrade",this.source)}focus(){this._focusable?.focus()}};oF.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},oF.styles=[tI`
			:host {
				display: block;
			}
		...
		`],oI([eM('a,button,[tabindex="0"]')],oF.prototype,"_focusable",2),oI([eL({type:Object})],oF.prototype,"promoPromise",2),oI([eL({type:Object})],oF.prototype,"source",2),oI([eL({reflect:!0,type:String})],oF.prototype,"type",2),oI([eL({type:Boolean,reflect:!0,attribute:"has-promo"})],oF.prototype,"hasPromo",1),oF=oI([eA("gl-promo")],oF);var oU=Object.defineProperty,oj=Object.getOwnPropertyDescriptor,oq=(t,e,o,r)=>{for(var n,a=r>1?void 0:r?oj(e,o):e,l=t.length-1;l>=0;l--)(n=t[l])&&(a=(r?n(e,o,a):n(a))||a);return r&&a&&oU(e,o,a),a};let oV=class extends lit_element_i{constructor(){super(...arguments),this.cloud=!1,this.placement="bottom",this.preview=!1}get daysRemaining(){var t,e,o,r;if(null==this.subscription)return 0;return t=this.subscription,e="days",o=t.plan.effective.expiresOn,r=e,(null!=o?function(t,e,o,r){let n=("number"==typeof e?e:e.getTime())-("number"==typeof t?t:t.getTime()),a=r??Math.floor;switch(o){case"days":return a(n/864e5);case"hours":return a(n/36e5);case"minutes":return a(n/6e4);case"seconds":return a(n/1e3);default:return n}}(Date.now(),new Date(o),r,Math.round):void 0)??0}get state(){return this.subscription?.state}render(){return eg`
		...
		`}renderBadge(){let t=this.preview?"Preview":"Pro";if(null!=this.subscription)if(this.state===eR.VerificationRequired)return eg`${t} <code-icon class="badge-icon" icon="warning" size="10"></code-icon>`;else{var e,o;if((e=this.subscription.plan.actual.id)!==eT.Community&&e!==eT.CommunityWithAccount||this.cloud&&null!=this.subscription.account)return eg`${t} <code-icon class="badge-icon" icon="check" size="10"></code-icon>`;if(null!=(o=this.state)&&(o===eR.ProPreview||o===eR.ProTrial))return eg`${t} <code-icon class="badge-icon" icon="clock" size="10"></code-icon>`}return t}renderPopoverHeader(){let t=eg`<span class="popup-title">${this.preview?"Preview feature":"Pro feature"}</span>`;return this.state===eR.Paid?eg`<div class="popup-header">${t}</div>`:this.cloud?this.preview?eg`<div class="popup-header">
			...
			${t}<span class="popup-subtitle"> Requires GitLens Pro for use on privately-hosted repos</span>
		</div>`}renderPopoverContent(){let t;if(null==this.subscription)return em;switch(this.state){case eR.Paid:var e;t=eg`<p>
					Your
					<gl-tooltip hoist content="Show Account view">
						<a href="${b("gitlens.showAccountView")}"
				...
				</p>`;break;case eR.VerificationRequired:t=eg`<p>You must verify your email before you can access Pro features.</p>
					<div class="actions">
						<gl-button
							density="tight"
							href="${b("gitlens.plus.resendVerification",this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${b("gitlens.plus.validate",this.source)}"
							><code-icon icon="refresh"></code-icon
						></gl-button>
					</div>`;break;case eR.ProTrial:{let e=this.daysRemaining;t=eg`<p>
						You have
						<strong>${e<1?"<1 day":ti("day",e,{infix:" more "})} left</strong>
						in your Pro trial. Once your trial ends, you will only be able to use Pro features on
						publicly-hosted repos.
					</p>
					${this.renderUpgradeActions()}`;break}case eR.ProTrialExpired:t=eg`<p>
						Your Pro trial has ended. You can now only use Pro features on publicly-hosted repos.
					</p>
					${this.renderUpgradeActions(eg`<p>Please upgrade for full access to all GitLens Pro features:</p>`)}`;break;case eR.ProTrialReactivationEligible:t=eg`<p>
					...
					<div class="actions center">
						<gl-button
							density="tight"
							href="${b("gitlens.plus.reactivateProTrial",this.source)}"
							tooltip="Reactivate your Pro trial for another ${ti("day",14)}"
							>Reactivate Pro Trial</gl-button
						>
					</div>`;break;default:if(!this.cloud&&this.state===eR.ProPreview){let e=this.daysRemaining;t=eg`<p>
							You have
							<strong>${e<1?"<1 day":ti("day",e,{infix:" more "})} left</strong>
							to preview
			...
			<gl-button density="tight" href="${b("gitlens.plus.signUp",this.source)}"
				>Start ${14}-day Pro Trial</gl-button
			>
			&nbsp;or
			<a href="${b("gitlens.plus.login",this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(t){return eg`<div class="actions">
			${t??em}
			<gl-button
				density="tight"
				href="${b("gitlens.plus.upgrade",{plan:eT.Pro,...this.source??{source:"feature-badge"}})}"
		...
		`],oq([eL({type:Boolean})],oV.prototype,"cloud",2),oq([eL({reflect:!0})],oV.prototype,"placement",2),oq([eL({type:Boolean})],oV.prototype,"preview",2),oq([function({context:t,subscribe:e}){return(o,r)=>{"object"==typeof r?r.addInitializer(function(){new s(this,{context:t,callback:t=>{o.set.call(this,t)},subscribe:e})}):o.constructor.addInitializer(o=>{new s(o,{context:t,callback:t=>{o[r]=t},subscribe:e})})}}({context:"promos"})],oV.prototype,"promos",2),oq([eL({type:Object})],oV.prototype,"source",2),oq([eL({attribute:!1})],oV.prototype,"subscription",2),oV=oq([eA("gl-feature-badge")],oV);var oZ=Object.defineProperty,oW=Object.getOwnPropertyDescriptor;let oG=class extends lit_element_i{render(){return eg`<svg
			alt="GitLens"
			width="159"
			height="46"
			viewBox="0 0 159 46"
		...
		`,r=[],n=(this.state.config.autolinks?.length||0)>0;n&&this.state.config.autolinks?.forEach((t,e)=>r.push(o(e,t))),r.push(o(this.state.config.autolinks?.length??0,void 0,!0,!n)),n&&r.push(e()),t.innerHTML=r.join("")}};function oJ(t){return"true"===t||"false"!==t&&("null"===t?null:t)}function oQ(t,e,o){let r=e.split("."),n=r.length,a=n-1,l=-1,h=t;for(;null!=h&&++l<n;){let t=r[l],e=o;if(l!==a){let o=h[t];e="object"==typeof o?o:{}}h[t]=e,h=h[t]}return t}function oX(t){switch(t){case"on":return!0;case"null":return null;case"undefined":return;default:return t}}new SettingsApp;export{SettingsApp};