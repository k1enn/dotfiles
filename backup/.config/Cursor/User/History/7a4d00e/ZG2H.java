...
public class FirebaseDataManager {
     ...
     */
    public void syncUserProgressAfterQuiz(int userId, int lessonId, int score) {
        try {
            ...
            if (progress != null && user != null) {
                ...
                int newXp = currentXp + score;
                progress.setXp(newXp);
                
                // Get current streak directly from the existing progress object
                // No need to create a new repository instance
