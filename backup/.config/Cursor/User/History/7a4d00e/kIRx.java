                        ...
                        if (userXp != null && userStreak != null) {
                            ...
                            AppDatabase.databaseWriteExecutor.execute(() -> {
                                try {
                                    ...
                                    // Update all progress entries for this user with the new values
                                    progressDao.updateUserXpAndStreak(userId, userXp.intValue(), userStreak.intValue());
                                    
                                    Log.d(TAG, "Directly updated local database - XP: " + userXp + ", Streak: " + userStreak);
                                    future.complete(true);
                                } catch (Exception e) {
