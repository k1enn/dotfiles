...
public class FirebaseDataManager {
    ...
    /**
     * Pull user progress from Firebase to local database - simplified version
            ...
            .addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        UserProgress progress = progressRepository.getCurrentProgress().getValue();
                        
                        if (progress != null) {
                            // Update local progress with Firebase data
                            if (userXp != null) {
                            ...
                            Log.d(TAG, "No local progress found to update");
                            future.complete(false);
                        }
                    } else {
