...
public class SpeechToText extends AppCompatActivity {
    ...
    private void completeInitialization() {
        try {
            ...
            Toast.makeText(this, "Error initializing UI. Please restart the app.", 
                    Toast.LENGTH_LONG).show();
            finish();
        }
    }
    ...
    private void initializeUI() {
        try {
            ...
            lottieConfetti.setAnimation(R.raw.confetti_animation);
    ...
    try {
        ...
        // Pass database to VoiceRecognizer with proper error handling
