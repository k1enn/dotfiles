...
public class DataInitializer {
    ...
    private static final int CURRENT_DATA_VERSION = 1; // Increment this when making changes

    public static void populateDatabase(AppDatabase db) {
        try {
            // Check if data needs to be updated (e.g., by checking a version in SharedPreferences)
