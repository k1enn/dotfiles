...
public class UserRepository {
    ...
    public User getUserByUsername(String username) {
        if (username == null || username.isEmpty()) {
            Log.e(TAG, "Cannot get user with empty username");
            return null;
        }
        
        try {
            // Execute the query on a background thread and wait for the result
            Future<User> future = AppDatabase.databaseWriteExecutor.submit(() -> 
            ...
            Log.e(TAG, "Error retrieving user by username: " + username, e);
            return null;
        }
    }
}