...
public class HomeFragment extends Fragment {
    ...
    private void initializeUI(View view) {
        try {
            ...
            // IMPORTANT: Don't try to find BottomNavigationView in the fragment layout
            // The BottomNavigationView is likely in the activity layout, not the fragment layout
