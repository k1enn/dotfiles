...
// Add event listener to the set-price dropdown
try {
    const setPriceElement = document.getElementById('set-price');
    if (!setPriceElement) {
        console.error('Set price element not found in DOM');
        return;
    }
    ...
    console.error('Error setting up set-price event listeners:', error);
}
