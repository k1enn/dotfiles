...
document.getElementById('set-price').addEventListener('change', function () {
    let selectedValue = this.value; // Remove const and initialize directly
    let currentTemplate = getCurrentTemplate(); // Remove const and initialize directly
    ...
    if (selectedValue === "1") { // Change condition to check for "1" specifically
