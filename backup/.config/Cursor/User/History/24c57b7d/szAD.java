...
public class PronunciationFragment extends Fragment implements VoiceRecognizer.RecognitionCallback {
    ...
    private void initialize() {
        ...
        // Set up speech recognizer listener
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle results) {
                ...
                if (matches != null && !matches.isEmpty()) {
                    ...
                    String targetWord = tvWord.getText().toString().toLowerCase();
                    boolean isCorrect = spokenText.equals(targetWord);
                    
                    // Call the callback method
                    onSpeechRecognized(spokenText, targetWord, isCorrect);
                }
            }
            
            // ... implement other RecognitionListener methods and forward to callback
        });
