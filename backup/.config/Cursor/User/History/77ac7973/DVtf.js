...
function setupMapToggle() {
    ...
    collapseMapButton.addEventListener("click", () => {
        ...
        if (mapContainer.classList.contains("collapsed")) {
            collapseMapButton.innerHTML = '<i class="fas fa-chevron-right"></i>';
            mapContainer.classList.remove("col-lg-3", "col-md-4");
            mapContainer.classList.add("col-auto");
            document.querySelector(".col-lg-9").classList.replace("col-lg-9", "col-lg-11");
            document.querySelector(".col-md-8").classList.replace("col-md-8", "col-md-11");
        } else {
            collapseMapButton.innerHTML = '<i class="fas fa-chevron-left"></i>';
            mapContainer.classList.add("col-lg-3", "col-md-4");
            mapContainer.classList.remove("col-auto");
            document.querySelector(".col-lg-11").classList.replace("col-lg-11", "col-lg-9");
            document.querySelector(".col-md-11").classList.replace("col-md-11", "col-md-8");
        }
    });
}
