...
function createQuestionsMap() {
    ...
    // Force grid layout with proper sizing - more aggressive overrides
    ...
    // Add wrapper div to isolate from Bootstrap's influence
    const originalMap = questionsMapElement.innerHTML;
    questionsMapElement.innerHTML = '';
    
    const gridWrapper = document.createElement('div');
    gridWrapper.className = 'grid-wrapper';
    gridWrapper.style.cssText = 'display: grid; grid-template-columns: repeat(4, 1fr); grid-gap: 8px; width: 100%;';
    gridWrapper.innerHTML = originalMap;
    
    questionsMapElement.appendChild(gridWrapper);
