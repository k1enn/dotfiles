...
class CryptoCandleStickChart extends StatelessWidget {
  ...
  const CryptoCandleStickChart({
    ...
    this.historicalData = const [
      PricePoint(price: 1, time: DateTime.now().subtract(const Duration(days: 9))),
      PricePoint(price: 2, time: DateTime.now().subtract(const Duration(days: 8))),
      PricePoint(price: 3, time: DateTime.now().subtract(const Duration(days: 7))),
      PricePoint(price: 4, time: DateTime.now().subtract(const Duration(days: 6))),
      PricePoint(price: 5, time: DateTime.now().subtract(const Duration(days: 5))),
      PricePoint(price: 6, time: DateTime.now().subtract(const Duration(days: 4))),
      PricePoint(price: 7, time: DateTime.now().subtract(const Duration(days: 3))),
      PricePoint(price: 8, time: DateTime.now().subtract(const Duration(days: 2))),
      PricePoint(price: 9, time: DateTime.now().subtract(const Duration(days: 1))),
      PricePoint(price: 10, time: DateTime.now()),
    ],
  });
