...
class _DashboardScreenState extends State<DashboardScreen> {
            ...
            children: [
              Text(
                ...
                style: AppTextStyles.caption.copyWith(
                  color: AppColors.gunmetal.withOpacity(0.6),
                ),
              ),
              const SizedBox(height: 4),
              Text('My Wallet', style: AppTextStyles.heading1),
            ],
          ),
          const Spacer(),
          Container(
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text('My Cryptocurrencies', style: AppTextStyles.heading3),
        ),
  ...
  Widget _buildCryptoCard(CryptoCurrency crypto, CryptoProvider provider) {
    ...
    return GestureDetector(
      ...
      child: Container(
        width: 200,
        margin: const EdgeInsets.only(right: 16, left: 2, top: 2, bottom: 4),
  ...
  Container _buildChart(CryptoCurrency crypto) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Price Chart (24h)', style: AppTextStyles.heading3),
