            ...
            public void onSuccess(FirebaseUser user) {
                ...
                try {
                    ...
                    if (authService.authenticateGoogleUser(email)) {
                        ...
                        synchronizer.restoreUserByEmail(email)
                            .thenAccept(restoredUser -> {
                                if (restoredUser != null) {
                                    Log.d(TAG, "Restored user data from Firebase for: " + email);
                                    // Optionally show a toast message about data restoration
                                }
                            })
                            .exceptionally(e -> {
                                Log.e(TAG, "Error restoring user data: " + e.getMessage(), e);
                                return null;
                            });
                    } else {
