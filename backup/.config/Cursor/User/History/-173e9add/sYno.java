...
public class FirebaseDbHelper {
    ...
    /**
     * Setup offline persistence for Firebase (must be called before any other Firebase database operations)
     */
    public void setupOfflinePersistence() {
        try {
    ...
    public CompletableFuture<Boolean> saveLessons(List<Lesson> lessonList) {
        ...
        try {
            ...
            for (Lesson lesson : lessonList) {
                ...
                lessonValues.put("topic", lesson.getTopic());
                lessonValues.put("difficultyLevel", lesson.getDifficultyLevel());
                lessonValues.put("imageUrl", lesson.getImageUrl());
                lessonValues.put("description", lesson.getDescription());
                lessonValues.put("conversationJson", lesson.getConversationJson());
