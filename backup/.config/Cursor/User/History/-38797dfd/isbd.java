        ...
        AppDatabase.databaseWriteExecutor.execute(() -> {
            try {
                ...
                firebaseDbHelper.saveVocabularyList(vocabularyList)
                    ...
                    .exceptionally(e -> {
                        Log.e(TAG, "Error syncing vocabulary: " + e.getMessage(), e);
                        future.complete(false);
                        return null;
                    });
            } catch (Exception e) {
                        ...
                        for (Vocabulary vocabulary : vocabularyList) {
                            try {
                                ...
                                Vocabulary existingVocab = database.vocabularyDao()
                                    .getVocabularyById(vocabulary.getVocabularyId());
                                ...
                                Log.e(TAG, "Error importing vocabulary " + vocabulary.getVocabularyId(), e);
                            }
                        }
