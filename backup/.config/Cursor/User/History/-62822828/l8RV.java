...
public class UserScoreRepository {
    ...
    public long insertUserScoreForLesson(int userId, int lessonId, int score) {
        // Find a quiz for this lesson
        Quiz quiz = quizRepository.getRandomQuizForLesson(lessonId);
        
        // Create and save the score
        UserScore userScore = new UserScore();
        userScore.setUserId(userId);
        userScore.setQuizId(quiz.getQuizId());
        userScore.setScore(score);
        userScore.setAttemptDate(getCurrentDate());
        
        return insertUserScore(userScore);
    }
} 