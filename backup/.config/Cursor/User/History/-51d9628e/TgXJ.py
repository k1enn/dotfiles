...
class TodoistTUI:
    ...
    def load_config(self):
        ...
        try:
            ...
            self.add_notification("Failed to load configuration", NotificationType.ERROR)
        return config
    ...
    def load_tasks(self):
        ...
        try:
            ...
            self.add_notification("Error loading tasks", NotificationType.ERROR)
    ...
    def save_tasks(self):
        ...
        try:
            ...
            self.add_notification("Error saving tasks", NotificationType.ERROR)
    ...
    def run(self, stdscr):
        ...
        notification_colors = {
            NotificationType.INFO: 8,      # Using info color
            NotificationType.SUCCESS: 7,   # Using success color
            NotificationType.WARNING: 9,   # Using warning color
            NotificationType.ERROR: 6      # Using error color
        }
        ...
        while True:
            ...
            if self.notifications:
                ...
                for i, notification in enumerate(self.notifications[:3]):  # Show at most 3 notifications
                    if y < height - 1:
                        ...
                        try:
                            stdscr.addstr(y, 2, message, curses.color_pair(color))
                        except curses.error:
            ...
            for i, task in enumerate(category_tasks[start_idx:end_idx], start=start_idx):
                ...
                if y < height - 5:  # Leave space for input area
                    ...
                    try:
                        stdscr.addstr(y, 2, task_str, curses.color_pair(color))
                    except curses.error:
                        # Handle potential display errors
                        pass
