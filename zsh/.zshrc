...
alias vi='vim'
alias cs='dotnet run'
alias reversetethering='cd /home/k1en/Documents/tethering/ && ./gnirehtet run && cd ~'
alias green-tunnel='nvm use 16 && green-tunnel'
alias update-shutdown='sudo dnf update -y && sudo shutdown now'
alias update-restart='sudo dnf update -y && sudo reboot'
alias update-hibernate='sudo dnf update -y && sudo systemctl hibernate -i'
...
export PATH="$PATH:/opt/mssql-tools/bin"
alias sql="sqlcmd -S localhost -U SA -P Dinhtrungkien05@"
